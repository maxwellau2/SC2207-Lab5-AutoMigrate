...
BEGIN
    ...
    VALUES
        ...
        (5, 'Monthly Passive Income', 600000, 12, 1672531200),  -- 2035 − 2023 = 12 years
        ...
        ( 2, 'Monthly Passive Income', 200000,    8, 1704048600),

        ( 3, 'Education Fund',         100000,    7, 1714500000),   -- Cynthia Ong (Grab)
        ( 3, 'Retirement',             800000,   22, 1714520000),
        ...
        ( 8, 'Retirement',             450000,   18, 1719970400),
        ...
        (11, 'Monthly Passive Income', 300000,   10, 1719780400),
        ...
        (13, 'Monthly Passive Income',          95000,    7, 1672531200),

        (14, 'Monthly Passive Income', 400000,   12, 1719770400),  -- Maya Wong (Standard Chartered)
